...
detect_model = tf.keras.models.load_model('C:/Users/inoh9/Desktop/ML/model_pyozunha')
...
def detect(predic):
  ...
  for i, logits in enumerate(predictions) :
      ...
      if (frame_no >= 3600):
        ...
        detect_data = tf.convert_to_tensor([[count, chcount*2, max_out, max_in, more_2sec*60, more_5sec*150]])
        #detect_data = tf.convert_to_tensor([[count, chcount*2, max_out, max_in, more_2sec*60, more_5sec*150, more_10secin*300]])
