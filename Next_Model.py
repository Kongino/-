...
train_dataset_fp = "C:/Users/inoh9/Desktop/ML/NoKada/111111.csv"
N=6
#column_names = ['eye', 'nose', 'ear', 'abnormal']

if (N==1):
  column_names = ['Count', 'abnormal']
if (N==2):
  column_names = ['Count','Change', 'abnormal']
if (N==3):
  column_names = ['Count','Change', 'Max_out', 'abnormal']
if (N==4):
  column_names = ['Count','Change', 'Max_out','Max_in', 'abnormal']
if (N==5):
  column_names = ['Count','Change', 'Max_out','Max_in', '2sec_out', 'abnormal']
if (N==6):
  column_names = ['Count', 'Change', 'Max_out', 'Max_in', '2sec_out','5sec_out', 'abnormal']
#column_names = ['Count', 'Change', 'Max_out', 'Max_in', '2sec_out','5sec_out', 'abnormal']
pre_names = ['Count', 'Change', 'Max_out', 'Max_in', '2sec_out', '5sec_out']
...
model = tf.keras.Sequential([
  tf.keras.layers.Dense(16, activation=tf.nn.relu, input_shape=(N,)),  # 입력의 형태가 필요합니다.
...
#model.save('C:/Users/inoh9/Desktop/ML/model_detect6')