...
public:
	...
	{
		ofstream fout("TestOK24.csv", ios::app);
		...
		if (datumsPtr != nullptr && !datumsPtr->empty())
		{
				...
				if (person == 0)
				{
					...
					for (auto bodyPart = 0; bodyPart < poseKeypoints.getSize(1); bodyPart++)
					{
						if (bodyPart == 0 || bodyPart == 15 || bodyPart == 16 || bodyPart == 17 || bodyPart == 18)
						{
							...
							{
								if (xyscore == poseKeypoints.getSize(2) - 2 && bodyPart == 18) // NoLabel part 아래에다 쉼표 하나 추가
			...
			if (0 >= poseKeypoints.getSize(0))
			{
				fout << "0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000";
				/*팔까지 인식*/
				//fout << ", 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000";
				//fout << "\n";
				fout << ", 0\n";
				fout << ", 1\n";
			}
